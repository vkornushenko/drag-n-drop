...
// we are guaranteed to always work with the exact same object
// one type object for the entire app
...
// abstract keyword means this class should be used
// only for inheritance (no direct instantiating)
